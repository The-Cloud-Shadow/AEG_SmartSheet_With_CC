...
- Removed outdated "Add Column" button from Toolbar component, leaving only the properly functioning "Add Column" button in the spreadsheet header that uses the modern modal dialog system